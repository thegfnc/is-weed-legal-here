  ...
  return (
    <header className='relative flex min-h-10 w-full items-center justify-center'>
      ...
      <div className='absolute right-0 top-0'>
        <Link
          href='/browse'
          className='flex max-w-10 items-center overflow-hidden whitespace-nowrap rounded-full p-2 transition-all duration-1000 ease-in-out will-change-[max-width] hover:max-w-48 hover:bg-gray-800/5'
        >
          <div>
