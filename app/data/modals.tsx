    ...
    body: (
      <>
        <div className='pt-6 leading-6'>
          ...
          with respect to any particular legal matter or their medical providers
          with respect to any health matter. No reader, user, or browser of this
          site should act or refrain from acting on the basis of information on
          this site without first seeking legal advice from counsel or medical
          advice from providers in the relevant jurisdiction. Only your
          individual attorney and medical providers can provide assurances that
          the information contained herein – and your interpretation of it – is
          applicable or appropriate to your particular situation. Use of, and
          access to, this website or any of the links or resources contained
